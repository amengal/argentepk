...
import { braceletsProducts, site } from "@/content/site";
import { SiteFooter } from "@/components/layout/SiteFooter";
import { SiteHeader } from "@/components/layout/SiteHeader";

export const metadata: Metadata = {
  title: "Bracelets",
  description: `${site.name} — bracelets.`,
};
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-5xl px-6 py-12 sm:px-8 sm:py-16">
          <nav aria-label="Breadcrumb" className="text-sm text-stone-600">
            ...
            <span className="text-stone-900">Bracelets</span>
          </nav>
          ...
          {braceletsProducts.map((product, productIndex) => (
            <section
              key={product.id}
              className={
                productIndex === 0
